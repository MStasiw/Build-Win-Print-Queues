...
# Enable spooling (buffer and queue print jobs): Advanced > "Spool print documents so program finishes printing faster" > "Start printing after last page is spooled"
